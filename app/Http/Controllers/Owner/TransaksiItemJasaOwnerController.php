...
class TransaksiItemJasaOwnerController extends Controller
{
    ...
    public function data($id)
    {
        ...
        foreach ($detail as $item) {
            ...
            $row['aksi']        = '<div class="btn-group">
                                    <button onclick="deleteData(`' . route('admin-transaksi-jasaitem.destroy', $item->id) . '`)" class="btn btn-xs btn-danger btn-flat"><i class="bi bi-trash"></i></button>
                                   </div>';
            $data[] = $row;
        }
