                ...
                <div class="container mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="box">
                                <div class="box-body">
                                    <table id="table-jasa" class="table table-stiped table-bordered">
                                        <thead>
                                            <th width="5%">No</th>
                                            <th>Nama</th>
                                            <th>Biaya</th>
                            ...
                            <form action="{{ route('admin-transaksi-jasa.update') }}" method="post">
                            @csrf
                    ...
                    @include('admin.transaksi.modalproduk')
                    <form id="data-delete"
                        action="" method="POST"
                        style="display: none;">
                        @csrf
    ...
    <script>
        ...
        $(function () {
            table = $('#table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('admin-transaksi-jasaitem.data', $id_transaksi) }}',
                },
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
        ...
        $(function () {
            tableJasa = $('#table-jasa').DataTable({
                processing: true,
                autoWidth: false,
                ajax: {
                    url: '{{ route('admin-transaksijasaitem.datajasa', $id_transaksi) }}',
                },
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
        ...
        function tambahProduk() {
            ...
            $.post('{{ route('admin-transaksi-jasaitem.store') }}', $('#form-item').serialize())
                .done(response => {        
        ...
        function loadForm(id) {
            ...
            $.get(`{{ url('/admin/transaksi-berobat/loadform') }}/${id}`)
                .done(response => {
