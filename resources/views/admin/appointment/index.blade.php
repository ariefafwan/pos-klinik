                                    ...
                                    <table class="table table-hover table-bordered">
                                        ...
                                        @foreach ($appointment as $app)
                                            ...
                                            <td align="center" class="d-flex justify-content-evenly">
                                                <button onclick="editForm(`{{ route('admin-appointment.update', $app->id) }}`, `{{ $app->id }}`)" class="btn btn-xs btn-info btn-flat"><i class="bi bi-pencil"></i></button>
                                                <button onclick="deleteData(`{{ route('admin-appointment.destroy', $app->id) }}`)" class="btn btn-xs btn-danger btn-flat"><i class="bi bi-trash"></i></button>
                                            </td>
                                        @endforeach
                                        @endif
                                        </tbody>
