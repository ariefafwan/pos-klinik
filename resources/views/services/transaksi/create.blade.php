                ...
                <div class="container mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <form action="{{ route('services-transaksi.update') }}" method="post">
                            @csrf
                    ...
                    @include('services.transaksi.modalproduk')
                    <form id="data-delete"
                        action="" method="POST"
                        style="display: none;">
                        @csrf
    ...
    <script>
        ...
        $(function () {
            table = $('#table').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('services-transaksiitem.data', $id_transaksi) }}',
                },
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
        ...
        $(function () {
            tableJasa = $('#table-jasa').DataTable({
                ...
                autoWidth: false,
                ajax: {
                    url: '{{ route('services-transaksiitem.datajasa', $id_transaksi) }}',
                },
                columns: [{
                        data: 'DT_RowIndex',
                        searchable: false,
        ...
        function tambahProduk() {
            ...
            $.post('{{ route('services-transaksiitem.store') }}', $('#form-item').serialize())
                .done(response => {        
        ...
        function loadForm(id) {
            ...
            $.get(`{{ url('/services/transaksi/loadform') }}/${id}`)
                .done(response => {
